...
const hexToRgb = (arr, color) => {
  ...
  for (let i = 0; i < arr.length + 1; i++) {
    let tempNum;
    // take first 2 numbers in arr - multiply first number by 16 power of 1, multiply second number by 16 power of 0.  Add results to get one number between 0 and 255
  ...
  // Print out result
  console.log(
    `Hex value ${color} into rgb values are: rgb(${arr[0]}, ${arr[1]}, ${arr[2]})`
  );
